...
: ${ZSH_DOTENV_ALLOWED_LIST:="${ZSH_CACHE_DIR:-$HOME/.cache/zsh}/dotenv-allowed.list"}
: ${ZSH_DOTENV_DISALLOWED_LIST:="${ZSH_CACHE_DIR:-$HOME/.cache/zsh}/dotenv-disallowed.list"}
